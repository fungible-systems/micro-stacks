...
import { BufferReader, TransactionVersion } from 'micro-stacks/common';
import {
  Address,
  addressToString,
  AssetInfo,
...
import { createStacksPublicKey } from 'micro-stacks/transactions';

describe('micro-stacks/transactions types tests', () => {
  ...
  test('Public keys to address hash', () => {
    const fixtures = [
      ...
      },
      {
        keys: [
          createStacksPublicKey(
            '020fadbbcea0ff3b05f03195b41cd991d7a0af8bd38559943aec99cbdaf0b22cc8'
          ),
        ],
        numRequired: 1,
        segwit: true,
      ...
      },
      {
        keys: [
          ...
          createStacksPublicKey(
            '02c77f262dda02580d65c9069a8a34c56bd77325bba4110b693b90216f5a3edc0b'
          ),
        ],
        numRequired: 2,
        segwit: true,
