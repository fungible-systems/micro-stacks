// Vendored from https://github.com/chiefbiiko/sha512 and modified to support the
// SHA2-512/256 initialization vector constants.

/** A class representation of the SHA2-512/256 algorithm. */
export class Sha512_256 {
  readonly hashSize: number = 32;
  ...
  update(msg: Uint8Array): Sha512_256 {
...
export function hashSha512_256(data: Uint8Array): Uint8Array {
  return new Sha512_256().update(data).digest();
}
