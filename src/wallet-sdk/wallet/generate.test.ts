...
describe(generateWallet, () => {
  test('backwards compatibility test', async () => {
    ...
    expect(getStxAddressFromAccount(account, StacksNetworkVersion.testnetP2PKH)).toEqual(
      'ST384CVPNDTYA0E92TKJZQTYXQHNZSWGCAH0ER64E'
    );
    expect(getStxAddressFromAccount(account)).toEqual('SP384CVPNDTYA0E92TKJZQTYXQHNZSWGCAG7SAPVB');
