...
<div className="mt-16 mb-20 text-center">
  [Overview](/docs/overview) · [Get Started](/docs/getting-started) · [Guides](/guides/stacks-apps) · [Core](/reference/core) · [GitHub](https://github.com/fungible-systems/micro-stacks)
</div>
