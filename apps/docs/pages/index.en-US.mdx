...
`micro-stacks` is an all-in-one JavaScript/TypeScript SDK for building robust and sophisticated decentralized apps on [Stacks](https://stacks.co).
With `micro-stacks` you can build apps that can: interact with [Clarity](https://clarity-lang.org), the smart contract language on Stacks,
...
In this example, we've imported `createClient` from `@micro-stacks/client`, created a new `client`, and then requested the user
authenticate, and once authentication completes, will be requested to sign a message. This is all you need to add web3 style
Stacks authentication to your app!
...
`micro-stacks` is created and maintained by [Fungible Systems](https://fungible.systems), a web3-focused design and engineering studio.
