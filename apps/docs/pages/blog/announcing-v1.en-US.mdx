...
![Announcing V1](/assets/blog/announcing-v1.png)
...
frontend tooling like Vite and SkyPack. Now `micro-stacks` is my go-to tooling for building modern,
robust Stacks applications and programs, along with the fine folks at [Gamma](https://gamma.io),
[Ryder](https://www.ryder.id/), [StackerDAOs](https://stackerdaos.com/),
[CityCoins](https://www.citycoins.co/), [Mechanism](https://mechanism.so),
[Zest](https://www.zestprotocol.com/), and more.
...
This new abstraction is a new library: `@micro-stacks/client`. This package is what handles all user
...
In addition to viewing the examples on GitHub, you can quickly create a new Stacks app with this
