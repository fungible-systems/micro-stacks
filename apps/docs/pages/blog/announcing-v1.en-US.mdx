...
things to have to think about when wanting to accomplish the foundational functionality that is
found in all Stacks apps: authentication, transaction signing, and using Gaia.
