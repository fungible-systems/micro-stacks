...
```tsx filename="network-toggle.tsx"
...
```svelte filename="network-toggle.svelte"
<script lang='ts'>
...
```vue filename="network-toggle.vue"
<script setup lang="ts">
