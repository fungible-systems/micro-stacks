...
<Integrations.React>
When building Stacks apps, very often you'll want to request the user to sign and broadcast a transaction to the network.
To do this, you need to interact with a connected Stacks wallet which can receive and use these requests. `@micro-stacks/react` exposes
a number of hooks that make this really easy.
</Integrations.React>

<Integrations.Vanilla>
When building Stacks apps, very often you'll want to request the user to sign and broadcast a transaction to the network.
To do this, you need to interact with a connected Stacks wallet which can receive and use these requests. `@micro-stacks/client` exposes
a number of functions that make this really easy.
</Integrations.Vanilla>
...
<Callout type='info'>
	To learn more about how best to work with post conditions, [check out the page on post conditions](./transactions/working-with-post-conditions).
</Callout>
