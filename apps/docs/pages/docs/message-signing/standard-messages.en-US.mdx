...
export const CodeSandbox = ({ id, tests }) => {
  return (
    <div className="mb-8 h-96 overflow-hidden rounded-md border-b border-gray-200 shadow-lg dark:border-gray-800 dark:!shadow-none sm:rounded-lg">
      <iframe
        title={id}
...
This will only show up if you have authenticated!

<CodeSandbox id="ilm7t7" />
</WithAuth>
